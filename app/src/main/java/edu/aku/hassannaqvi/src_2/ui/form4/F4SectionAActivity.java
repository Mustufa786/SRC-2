...
public class F4SectionAActivity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        f1.put("f4a03", bi.f4a03x.getText().toString());
        f1.put("f4a0398", bi.f4a03.isChecked() ? "98" : "0");
        f1.put("f4a04", bi.f4a04a.isChecked() ? "1"
                : bi.f4a04b.isChecked() ? "2"
                : bi.f4a04c.isChecked() ? "3"
                : "0");
        f1.put("f4a0596x", bi.f4a0596x.getText().toString());
        f1.put("f4a05", bi.f4a05a.isChecked() ? "1"
                : bi.f4a05b.isChecked() ? "2"
                : bi.f4a05c.isChecked() ? "3"
                : bi.f4a05d.isChecked() ? "4"
                : bi.f4a05e.isChecked() ? "5"
                : bi.f4a05f.isChecked() ? "6"
                : bi.f4a05g.isChecked() ? "7"
                : bi.f4a0596.isChecked() ? "96"
                : "0");
        f1.put("f4a0696x", bi.f4a0696x.getText().toString());
        f1.put("f4a06", bi.f4a06a.isChecked() ? "1"
                : bi.f4a06b.isChecked() ? "2"
                : bi.f4a06c.isChecked() ? "3"
                : bi.f4a06d.isChecked() ? "4"
                : bi.f4a06e.isChecked() ? "5"
                : bi.f4a06f.isChecked() ? "6"
                : bi.f4a06g.isChecked() ? "7"
                : bi.f4a06h.isChecked() ? "8"
                : bi.f4a0698.isChecked() ? "98"
                : bi.f4a0696.isChecked() ? "96"
                : "0");
        ...
        f1.put("f4a09", bi.f4a09a.isChecked() ? "1"
                : bi.f4a09b.isChecked() ? "2"
                : bi.f4a09c.isChecked() ? "3"
                : bi.f4a09d.isChecked() ? "4"
                : bi.f4a09e.isChecked() ? "5"
                : "0");
        ...
        f1.put("f4a12", bi.f4a12a.isChecked() ? "1"
                : bi.f4a12b.isChecked() ? "2"
                : bi.f4a12c.isChecked() ? "3"
                : bi.f4a12d.isChecked() ? "4"
                : bi.f4a12e.isChecked() ? "5"
                : "0");
        f1.put("f4a13", bi.f4a13a.isChecked() ? "1" : bi.f4a13b.isChecked() ? "2" : "0");
        f1.put("f4a14", bi.f4a14a.isChecked() ? "1"
