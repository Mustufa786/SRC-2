...
public class F2SectionAActivity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        f1.put("f2a01",bi.f2a01a.isChecked() ?"1" :bi.f2a01b.isChecked() ?"2" :bi.f2a01c.isChecked() ?"3" :bi.f2a01d.isChecked() ?"4" :bi.f2a01e.isChecked() ?"5" :bi.f2a01f.isChecked() ?"6" :bi.f2a01g.isChecked() ?"7" :bi.f2a01h.isChecked() ?"8" :bi.f2a01i.isChecked() ?"9" :bi.f2a01j.isChecked() ?"10" :bi.f2a01k.isChecked() ?"11" :bi.f2a01l.isChecked() ?"12" :bi.f2a01m.isChecked() ?"13" :bi.f2a01n.isChecked() ?"14" :bi.f2a01o.isChecked() ?"15" :bi.f2a0196.isChecked() ?"96" :"0");
