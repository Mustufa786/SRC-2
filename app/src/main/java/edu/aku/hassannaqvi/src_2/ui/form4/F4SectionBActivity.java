...
public class F4SectionBActivity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        f1.put("f4b01", bi.f4b01a.isChecked() ? "1"
                : bi.f4b01b.isChecked() ? "2"
                : bi.f4b01c.isChecked() ? "3"
                : bi.f4b01d.isChecked() ? "4"
                : bi.f4b01e.isChecked() ? "5"
                : bi.f4b01f.isChecked() ? "6"
                : bi.f4b01g.isChecked() ? "7"
                : "0");
        f1.put("f4b0296x", bi.f4b0296x.getText().toString());
        f1.put("f4b02", bi.f4b02a.isChecked() ? "1"
                : bi.f4b02b.isChecked() ? "2"
                : bi.f4b02c.isChecked() ? "3"
        ...
        f1.put("f4b03", bi.f4b03a.isChecked() ? "1"
                : bi.f4b03b.isChecked() ? "2"
                : bi.f4b03c.isChecked() ? "3"
                : bi.f4b03d.isChecked() ? "4"
                : bi.f4b03e.isChecked() ? "5"
                : bi.f4b03f.isChecked() ? "6"
                : bi.f4b03g.isChecked() ? "7"
                : bi.f4b03h.isChecked() ? "8"
                : bi.f4b03i.isChecked() ? "9"
                : bi.f4b0396.isChecked() ? "96"
                : "0");
        f1.put("f4b0396x", bi.f4b0396x.getText().toString());
        f1.put("f4c01", bi.f4c01a.isChecked() ? "1"
                : bi.f4c01b.isChecked() ? "2"
                : "0");
        f1.put("f4c02", bi.f4c02.getText().toString());
        ...
        f1.put("f4c06", bi.f4c06a.isChecked() ? "1"
                : bi.f4c06b.isChecked() ? "2"
                : bi.f4c06c.isChecked() ? "3"
                : bi.f4c06d.isChecked() ? "4"
                : bi.f4c06e.isChecked() ? "5"
                : bi.f4c06f.isChecked() ? "6"
                : bi.f4c06g.isChecked() ? "7"
                : bi.f4c0696.isChecked() ? "96"
                : "0");
