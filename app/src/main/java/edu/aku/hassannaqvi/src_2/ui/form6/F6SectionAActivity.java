...
public class F6SectionAActivity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        f1.put("f6a04", bi.f6a04a.isChecked() ? "1"
                : bi.f6a04b.isChecked() ? "2"
                : bi.f6a04c.isChecked() ? "3"
                : bi.f6a04d.isChecked() ? "4"
                : bi.f6a04e.isChecked() ? "5"
                : bi.f6a0498.isChecked() ? "98" : "0");
        f1.put("f6a05", bi.f6a05a.isChecked() ? "1"
                : bi.f6a05b.isChecked() ? "2"
                : bi.f6a05c.isChecked() ? "98"
                : "0");
        f1.put("f6a06", bi.f6a06a.isChecked() ? "1"
                : bi.f6a06b.isChecked() ? "2"
                : bi.f6a06c.isChecked() ? "3"
                : bi.f6a06d.isChecked() ? "4"
                : "0");
        f1.put("f6a0796x", bi.f6a0796x.getText().toString());
        f1.put("f6a07", bi.f6a07a.isChecked() ? "1"
                : bi.f6a07b.isChecked() ? "2"
                : bi.f6a07c.isChecked() ? "3"
                : bi.f6a07d.isChecked() ? "4"
                : bi.f6a0796.isChecked() ? "96"
                : "0");
        ...
        f1.put("f6a11", bi.f6a11a.isChecked() ? "1"
                : bi.f6a11b.isChecked() ? "2"
                : bi.f6a11c.isChecked() ? "3"
                : bi.f6a1198.isChecked() ? "98"
                : bi.f6a1196.isChecked() ? "96"
                : "0");
